  ...
  <section id="content-body">
  	<div class="container">
  		<div class="row row-1">
   		...
   		<div class="row row-2">
   			<div class="col-md-3">
				<div class="panel panel-cardiology">
				  <div class="panel-heading">
				    <h3 class="panel-title better-font">Find a Service</h3>
				  </div>
				  <div class="panel-body">
				    <p><small>From the largest range of pediatric specialists that will keep your child healthy to a state-of-the-art children's hospital, we offer world-class care for kids.</small></p>
				  	<p><hr></p>
...
<!-- Modal -->
<div class="modal fade" id="docListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-cnhs">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title modal-title-cardiology" id="myModalLabel">Top Doctors</h4>
      </div>
      <div class="modal-body">
		<div class="list-group col-xs-12 col-sm-6 col-md-6 col-lg-6 provider-listing">
			...
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/fran-cogen" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Fran Cogen, Endocrinology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/lawrence-d-angelo" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Lawrence D'Angelo, Adolescent and Young Adult Medicine</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/roberta-debiasi" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Roberta DeBiasi, Infectious Disease</a>
			...
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/thomas-hougen" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Thomas Hougen, Cardiology</a>
		...
		<div class="list-group col-xs-12 col-sm-6 col-md-6 col-lg-6 provider-listing">
			...
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/scott-norton" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Scott Norton, Dermatology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/matthew-oetgen" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Matthew Oetgen, Orthopaedic Surgery and Sports Medicine</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/craig-peters" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Craig Peters, Urology</a>
			...
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/billie-lou-short" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Billie Lou Short, Neonatology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/brian-stone" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Brian Stone, Neonatology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/jonathan-taylormoore" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Jonathan Taylormoore, Ophthalmology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/priya-vaidyanathan" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">Priya Vaidyanathan, Endocrinology</a>
			<a href="http://childrensnational.org/choose-childrens/find-a-provider/johannes-van-den-anker" target="_blank" trackingLabel="Top Doctor in Light Box" class="list-group-item list-group-item-cardiology">John van den Anker, Neonatology</a>
